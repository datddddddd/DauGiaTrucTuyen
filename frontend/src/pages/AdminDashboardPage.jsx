                          ...
                          <tr key={pay.id} className="hover:bg-slate-50/50 dark:hover:bg-slate-850/50 transition">
                            ...
                            <td className="p-3 space-x-2 whitespace-nowrap">
                              <button
                                ...
                                className="px-2.5 py-1 border border-slate-300 dark:border-slate-700 hover:bg-slate-100 dark:hover:bg-slate-800 text-slate-800 dark:text-white font-bold rounded-lg text-[10px]"
                              >
                                Chi tiết
                              </button>
                              {pay.status === "WaitingForPayout" && (
                                <button
                                  ...
                                  className="px-2.5 py-1 border border-red-500 text-red-600 dark:text-red-400 hover:bg-red-600 hover:text-white font-bold rounded-lg text-[10px] transition-colors"
                                >
                                  Giải ngân
                                </button>
                              )}
              ...
              <div className="flex justify-end gap-3 bg-slate-50 dark:bg-slate-850 px-6 py-4 border-t border-slate-100 dark:border-slate-800">
                ...
                {selectedPayment.status === "WaitingForPayout" && (
                  <button
                    ...
                    className="px-4 py-2 bg-red-600 hover:bg-red-700 text-white font-black rounded-xl transition-colors"
                  >
                    Giải ngân
                  </button>
                )}
